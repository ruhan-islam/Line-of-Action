...
public class AI_Main_v3 {
    ...
    public AI_Main_v3(boolean is1st) {
...
//        }
        ...
        System.out.println(this.comparisonCount + ": " + score + " " + this.maxDepth);
        this.printBoard();
        System.out.println();
...
//                                this.comparisonCount++;
    ...
    private int evaluate() {
        ...
        score -= this.myChange * 1000;
        score += this.opChange * 1000;
